model TbLib
  ...
  model Shelf
    ...
    Modelica.Mechanics.Rotational.Components.Inertia BodyInertia(J = 0.1) annotation(Placement(visible = true, transformation(origin = {-28, 6}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    ...
    Modelica.Mechanics.Rotational.Components.SpringDamper springdamper1(c = 10000, d = 1000) annotation(Placement(visible = true, transformation(origin = {-64, 6}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Mechanics.Rotational.Components.SpringDamper springdamper2(c = 10000, d = 1000) annotation(Placement(visible = true, transformation(origin = {34, 6}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  equation
    connect(springdamper2.flange_b, flange_b) annotation(Line(points = {{44, 6}, {92, 6}}));
    connect(BodyInertia.flange_b, springdamper2.flange_a) annotation(Line(points = {{-18, 6}, {24, 6}}));
    connect(springdamper1.flange_b, BodyInertia.flange_a) annotation(Line(points = {{-54, 6}, {-38, 6}, {-38, 6}, {-38, 6}}));
    connect(flange_a, springdamper1.flange_a) annotation(Line(points = {{-94, 6}, {-74, 6}, {-74, 6}, {-74, 6}}));
  ...
  model Cargo
    ...
    Modelica.Mechanics.Rotational.Components.SpringDamper springdamper1(c = 10000, d = 1000) annotation(Placement(visible = true, transformation(origin = {-66, 6}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  equation
    connect(springdamper1.flange_b, BodyInertia.flange_a) annotation(Line(points = {{-56, 6}, {-38, 6}, {-38, 6}, {-38, 6}}));
    connect(flange_a, springdamper1.flange_a) annotation(Line(points = {{-94, 6}, {-76, 6}, {-76, 6}, {-76, 6}}));
  ...
  model BatteryV2
    ...
    Modelica.Mechanics.Rotational.Components.Inertia inertia1(J = 0.1) annotation(Placement(visible = true, transformation(origin = {28, 4}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
