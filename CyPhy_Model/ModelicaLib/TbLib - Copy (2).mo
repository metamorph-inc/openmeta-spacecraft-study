model TbLib
  ...
  model Test1
    TbLib.scenario scenario1(commTime = 50, per = 1000, tstart = 100) annotation(Placement(visible = true, transformation(origin = {-82, 10}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    TbLib.Gyroscope gyroscope1(torquegain = 10, powergain = 10) annotation(Placement(visible = true, transformation(origin = {-16, 14}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    TbLib.Computer computer1(k = 1, p = 1, d = 1) annotation(Placement(visible = true, transformation(origin = {-48, 14}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    TbLib.BattCapSurrogate battcapsurrogate1(CEquivalent = 10) annotation(Placement(visible = true, transformation(origin = {32, 50}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    TbLib.Body body1(ixx = 1) annotation(Placement(visible = true, transformation(origin = {24, 14}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    TbLib.PVPanel pvpanel1(pvGain = 1) annotation(Placement(visible = true, transformation(origin = {-38, 54}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  equation
    connect(body1.angle, pvpanel1.incidentAngle) annotation(Line(points = {{34, 15}, {54, 15}, {54, 70}, {-54, 70}, {-54, 60}, {-48, 60}, {-48, 60}}, color = {0, 0, 127}));
    connect(pvpanel1.pin_n, battcapsurrogate1.pin_n) annotation(Line(points = {{-30, 46}, {12, 46}, {12, 42}, {22, 42}, {22, 42}}, color = {0, 0, 255}));
    connect(pvpanel1.pin_p, battcapsurrogate1.pin_p) annotation(Line(points = {{-29, 64}, {12, 64}, {12, 57}, {23, 57}}, color = {0, 0, 255}));
    connect(battcapsurrogate1.pin_n, body1.pin_n) annotation(Line(points = {{23, 43}, {0, 43}, {0, 6}, {14, 6}, {14, 6}}, color = {0, 0, 255}));
    connect(battcapsurrogate1.pin_p, body1.pin_p) annotation(Line(points = {{23, 57}, {6, 57}, {6, 22}, {14, 22}, {14, 22}}, color = {0, 0, 255}));
    connect(body1.angle, computer1.angleMeas) annotation(Line(points = {{34, 15}, {34, -8}, {-62, -8}, {-62, 10}, {-57, 10}}, color = {0, 0, 127}));
    connect(gyroscope1.pin_n, body1.pin_n) annotation(Line(points = {{-7, 6}, {15, 6}}, color = {0, 0, 255}));
    connect(gyroscope1.pin_p, body1.pin_p) annotation(Line(points = {{-7, 22}, {14, 22}}, color = {0, 0, 255}));
    connect(gyroscope1.flange_b, body1.flange_a) annotation(Line(points = {{-7, 12}, {12, 12}, {12, 15}, {15, 15}}));
    connect(computer1.torque, gyroscope1.torque) annotation(Line(points = {{-38, 16}, {-30, 16}, {-30, 14}, {-26, 14}, {-26, 14}}, color = {0, 0, 127}));
    connect(computer1.pin_n, gyroscope1.pin_n) annotation(Line(points = {{-39, 5}, {-38, 5}, {-38, 0}, {-8, 0}, {-8, 6}, {-8, 6}}, color = {0, 0, 255}));
    connect(computer1.pin_p, gyroscope1.pin_p) annotation(Line(points = {{-39, 23}, {-38, 23}, {-38, 30}, {-6, 30}, {-6, 22}, {-6, 22}}, color = {0, 0, 255}));
    connect(scenario1.y, computer1.setpoint) annotation(Line(points = {{-78, 14}, {-66, 14}, {-66, 16}, {-58, 16}, {-58, 16}}, color = {0, 0, 127}));
  ...
  model Gyroscope
    ...
    Modelica.Electrical.Analog.Basic.Ground ground1 annotation(Placement(visible = true, transformation(origin = {28, -98}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    ...
    Modelica.Mechanics.Rotational.Interfaces.Flange_b flange_b annotation(Placement(visible = true, transformation(origin = {90, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {90, -18}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Electrical.Analog.Interfaces.NegativePin pin_n annotation(Placement(visible = true, transformation(origin = {90, -68}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {88, -80}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    ...
    output Modelica.Blocks.Interfaces.RealOutput current "current consumed" annotation(Placement(visible = true, transformation(origin = {98, 36}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {88, 4}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  equation
    ...
    connect(torque1.flange, flange_b) annotation(Line(points = {{-6, -40}, {90, -40}, {90, -42}, {90, -42}}));
    connect(signalcurrent1.n, pin_n) annotation(Line(points = {{28, -10}, {28, -10}, {28, -68}, {92, -68}, {92, -68}}, color = {0, 0, 255}));
    connect(currentsensor1.n, pin_p) annotation(Line(points = {{50, 60}, {94, 60}, {94, 60}, {94, 60}}, color = {0, 0, 255}));
    connect(ground1.p, signalcurrent1.n) annotation(Line(points = {{28, -88}, {28, -88}, {28, -10}, {28, -10}}, color = {0, 0, 255}));
