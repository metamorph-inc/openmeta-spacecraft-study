...
void DC_Spacecraft_22_function_initSample(DATA *data)
{
  long i=0;
}

const char *DC_Spacecraft_22_zeroCrossingDescription(int i, int **out_EquationIndexes)
{
...
int DC_Spacecraft_22_function_ZeroCrossingsEquations(DATA *data)
{
  TRACE_PUSH
...
int DC_Spacecraft_22_function_ZeroCrossings(DATA *data, double *gout)
{
  TRACE_PUSH
...
const char *DC_Spacecraft_22_relationDescription(int i)
{
...
int DC_Spacecraft_22_function_updateRelations(DATA *data, int evalforZeroCross)
{
  TRACE_PUSH
...
int DC_Spacecraft_22_checkForDiscreteChanges(DATA *data)
{
  TRACE_PUSH
  int needToIterate = 0;
