...
int DC_Spacecraft_22_initialAnalyticJacobianD(void* inData)
{
  TRACE_PUSH
  TRACE_POP
  return 1;
}
int DC_Spacecraft_22_initialAnalyticJacobianC(void* inData)
{
  TRACE_PUSH
  TRACE_POP
  return 1;
}
int DC_Spacecraft_22_initialAnalyticJacobianB(void* inData)
{
  TRACE_PUSH
  TRACE_POP
  return 1;
...
static void DC_Spacecraft_22_initialAnalyticJacobianA_0(DATA* data, int index)
{
  int i;
...
static void DC_Spacecraft_22_initialAnalyticJacobianA_1(DATA* data, int index)
{
  int i;
...
static void DC_Spacecraft_22_initialAnalyticJacobianA_2(DATA* data, int index)
{
  int i;
...
static void DC_Spacecraft_22_initialAnalyticJacobianA_3(DATA* data, int index)
{
  int i;
...
static void DC_Spacecraft_22_initialAnalyticJacobianA_4(DATA* data, int index)
{
  int i;
...
static void DC_Spacecraft_22_initialAnalyticJacobianA_5(DATA* data, int index)
{
  int i;
...
int DC_Spacecraft_22_initialAnalyticJacobianA(void* inData)
{
  TRACE_PUSH
  DATA* data = ((DATA*)inData);
  int index = DC_Spacecraft_22_INDEX_JAC_A;
  ...
  DC_Spacecraft_22_initialAnalyticJacobianA_0(data, index);
  DC_Spacecraft_22_initialAnalyticJacobianA_1(data, index);
  DC_Spacecraft_22_initialAnalyticJacobianA_2(data, index);
  DC_Spacecraft_22_initialAnalyticJacobianA_3(data, index);
  DC_Spacecraft_22_initialAnalyticJacobianA_4(data, index);
  DC_Spacecraft_22_initialAnalyticJacobianA_5(data, index);
...
int DC_Spacecraft_22_functionJacA_column(void* inData)
{
  TRACE_PUSH
