...
extern "C" {
#endif
  #define DC_Spacecraft_333_INDEX_JAC_D 3
  int DC_Spacecraft_333_functionJacD_column(void* data);
  int DC_Spacecraft_333_initialAnalyticJacobianD(void* data);
#if defined(__cplusplus)
}
#endif
/* D */
...
extern "C" {
#endif
  #define DC_Spacecraft_333_INDEX_JAC_C 2
  int DC_Spacecraft_333_functionJacC_column(void* data);
  int DC_Spacecraft_333_initialAnalyticJacobianC(void* data);
#if defined(__cplusplus)
}
#endif
/* C */
...
extern "C" {
#endif
  #define DC_Spacecraft_333_INDEX_JAC_B 1
  int DC_Spacecraft_333_functionJacB_column(void* data);
  int DC_Spacecraft_333_initialAnalyticJacobianB(void* data);
#if defined(__cplusplus)
}
#endif
/* B */
...
extern "C" {
#endif
  #define DC_Spacecraft_333_INDEX_JAC_A 0
  int DC_Spacecraft_333_functionJacA_column(void* data);
  int DC_Spacecraft_333_initialAnalyticJacobianA(void* data);
#if defined(__cplusplus)
}
#endif
/* A */
