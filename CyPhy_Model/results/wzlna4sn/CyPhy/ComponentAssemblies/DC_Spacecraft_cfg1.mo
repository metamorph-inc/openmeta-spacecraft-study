...
__CyPhy__powerRatio=GyroSize) annotation(choicesAllMatching=true, Placement(transformation(origin={43,-124}, extent={{-15,-15},{15,15}})));
  CyPhy.Components.RootFolder.A_Space_Components.Energy.Solar_Panels_4A Solar_Panels_A__Solar_Panels_4A(
__CyPhy__Angle_Between_Panels=Panel_Angle) annotation(choicesAllMatching=true, Placement(transformation(origin={257,-45}, extent={{-15,-15},{15,15}})));
  CyPhy.Components.RootFolder.A_Space_Components.Energy.Solar_Panels_4B Solar_Panels_B__Solar_Panels_4B(
...
equation
  ...
  connect(Computers.solarOut, Solar_Panels_B__Solar_Panels_4B.u) annotation(Line(points = {{0.0,0.0},{0.1,0.1}}));
  ...
  connect(current_solarCell__i, Solar_Panels_A__Solar_Panels_4A.i) annotation(Line(points = {{0.0,0.0},{0.1,0.1}}));
  connect(Gyroscope_Momentum_Control.pin_n, Solar_Panels_B__Solar_Panels_4B.pin_n) annotation(Line(points = {{0.0,0.0},{0.1,0.1}},color={0,0,255}));
  connect(Gyroscope_Momentum_Control.pin_p, Solar_Panels_B__Solar_Panels_4B.pin_p) annotation(Line(points = {{0.0,0.0},{0.1,0.1}},color={0,0,255}));
  connect(Solar_Panels_A__Solar_Panels_4A.pin_n, Solar_Panels_B__Solar_Panels_4B.pin_n) annotation(Line(points = {{0.0,0.0},{0.1,0.1}},color={0,0,255}));
  connect(Solar_Panels_A__Solar_Panels_4A.pin_p, Solar_Panels_B__Solar_Panels_4B.pin_p) annotation(Line(points = {{0.0,0.0},{0.1,0.1}},color={0,0,255}));
  connect(Solar_Panels_A__Solar_Panels_4A.u, Solar_Panels_B__Solar_Panels_4B.u) annotation(Line(points = {{0.0,0.0},{0.1,0.1}}));
  connect(Solar_Panels_A__Solar_Panels_4A.v, voltage_bus__i) annotation(Line(points = {{0.0,0.0},{0.1,0.1}}));
