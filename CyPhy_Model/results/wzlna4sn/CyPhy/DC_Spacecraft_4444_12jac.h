...
extern "C" {
#endif
  #define DC_Spacecraft_4444_INDEX_JAC_D 3
  int DC_Spacecraft_4444_functionJacD_column(void* data);
  int DC_Spacecraft_4444_initialAnalyticJacobianD(void* data);
#if defined(__cplusplus)
}
#endif
/* D */
...
extern "C" {
#endif
  #define DC_Spacecraft_4444_INDEX_JAC_C 2
  int DC_Spacecraft_4444_functionJacC_column(void* data);
  int DC_Spacecraft_4444_initialAnalyticJacobianC(void* data);
#if defined(__cplusplus)
}
#endif
/* C */
...
extern "C" {
#endif
  #define DC_Spacecraft_4444_INDEX_JAC_B 1
  int DC_Spacecraft_4444_functionJacB_column(void* data);
  int DC_Spacecraft_4444_initialAnalyticJacobianB(void* data);
#if defined(__cplusplus)
}
#endif
/* B */
...
extern "C" {
#endif
  #define DC_Spacecraft_4444_INDEX_JAC_A 0
  int DC_Spacecraft_4444_functionJacA_column(void* data);
  int DC_Spacecraft_4444_initialAnalyticJacobianA(void* data);
#if defined(__cplusplus)
}
#endif
/* A */
